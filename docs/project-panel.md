...
- No larger/centered image preview for the cover — VSCode's tree view only supports small icon-sized thumbnails; a bigger preview would need a custom webview, not implemented.
