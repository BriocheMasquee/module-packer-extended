...
- **No `=WIDTHxHEIGHT` image-sizing syntax** — a small EncounterPlus-specific Markdown extension from the original tooling, deferred, see [issue #14](https://github.com/BriocheMasquee/mpx-bis/issues/14).
